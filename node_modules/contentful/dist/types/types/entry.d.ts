...
export declare namespace EntryFieldTypes {
    ...
    type Array<Item extends EntryFieldTypes.Symbol | EntryFieldTypes.AssetLink | EntryFieldTypes.EntryLink<EntrySkeletonType> | EntryFieldTypes.EntryResourceLink<EntrySkeletonType>> = {
        type: 'Array';
        item: Item;
    };
 ...
 * @category Entry
 */
export type EntryFieldType<EntrySkeleton extends EntrySkeletonType> = EntryFieldTypes.Symbol | EntryFieldTypes.Text | EntryFieldTypes.Integer | EntryFieldTypes.Number | EntryFieldTypes.Date | EntryFieldTypes.Boolean | EntryFieldTypes.Location | EntryFieldTypes.RichText | EntryFieldTypes.Object | EntryFieldTypes.EntryLink<EntrySkeleton> | EntryFieldTypes.EntryResourceLink<EntrySkeleton> | EntryFieldTypes.AssetLink | EntryFieldTypes.Array<EntryFieldTypes.Symbol> | EntryFieldTypes.Array<EntryFieldTypes.AssetLink> | EntryFieldTypes.Array<EntryFieldTypes.EntryLink<EntrySkeleton>> | EntryFieldTypes.Array<EntryFieldTypes.EntryResourceLink<EntrySkeleton>>;
/**
 ...
 * @internal
 */
export type ResolvedAssetLink<Modifiers extends ChainModifiers> = ChainModifiers extends Modifiers ? Asset | {
    sys: AssetLink;
} | undefined : 'WITHOUT_LINK_RESOLUTION' extends Modifiers ? {
    sys: AssetLink;
} : 'WITHOUT_UNRESOLVABLE_LINKS' extends Modifiers ? Asset | undefined : Asset | {
    sys: AssetLink;
};
/**
 ...
 * @internal
 */
export type ResolvedLink<Field extends EntryFieldType<EntrySkeletonType>, Modifiers extends ChainModifiers = ChainModifiers, Locales extends LocaleCode = LocaleCode> = Field extends EntryFieldTypes.EntryLink<infer LinkedEntry> ? ResolvedEntryLink<Modifiers, Locales, LinkedEntry> : Field extends EntryFieldTypes.EntryResourceLink<infer LinkedEntry> ? ResolvedEntryResourceLink<Modifiers, Locales, LinkedEntry> : Field extends EntryFieldTypes.AssetLink ? ResolvedAssetLink<Modifiers> : BaseFieldMap<Field>;
/**
